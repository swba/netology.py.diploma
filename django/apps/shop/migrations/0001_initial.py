    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='shop.shippingaddress', verbose_name='Shipping Address')),
            ],
            options={
                'verbose_name': 'Order',
